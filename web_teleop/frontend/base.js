Base = function(ros) {
  ...
  var baseRotateLeft = document.querySelector('#baseRotateLeft');
  var baseRotateRight = document.querySelector('#baseRotateRight');
  ...
  this.baseRotateLeft = function() {
    that._timer = setInterval(function() {
      move(0, that.angularSpeed)
    }, 50);
  }

  this.baseRotateRight = function() {
    that._timer = setInterval(function() {
      move(0, -that.angularSpeed)
    }, 50);
  }
  ...
  baseRotateLeft.addEventListener('mousedown', that.baseRotateLeft);
  baseRotateRight.addEventListener('mousedown', that.baseRotateRight);
