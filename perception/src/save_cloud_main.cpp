...
int main(int argc, char** argv) { 
    ros::init(argc, argv, "team5_save_cloud");
    if (argc < 2) { 
        print_usage();
        return 1;
    } 
    ...
    sensor_msgs::PointCloud2ConstPtr cloud = ros::topic::waitForMessage<sensor_msgs::PointCloud2>("head_camera/depth_registered/points");
