...
class Arm(object):
    ...
    def moveit_error_string(self, val):
        ...
        if val == MoveItErrorCodes.SUCCESS:
            ...
            return 'INVALID_Relf.moveit_error_string(OBOT_STATE'
    ...
    def move_to_pose(self,
        ...
        if orientation is not None:
            goal_builder.add_path_orientation_contraint(orientation)
        ...
        if result is None:
            ...
            error = self.moveit_error_string(result.error_code.val)
        if error == 'SUCCESS':
            return None
        return error
